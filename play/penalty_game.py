# Règle : Une cage de foot est déssiner, en fonction du niveau de votre joueur choisi, chaque zone possède une probailité de cadre 
# (Tire dans la cage) ainsi qu'une probabilité d'arrêt, pour marquer il suffit d'avoir soit le meilleur joueur, soit de la chance
# 
